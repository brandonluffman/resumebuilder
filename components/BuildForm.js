  ...
  {formData.workExperience.map((experience, index) => (
    ...
    <div className='multi-input-container'>
      ...
      <div className='multi-input-div'>
        ...
        <input type="text" placeholder="Dates" value={newEducation.dates} onChange={(e) => setNewEducation({ ...newEducation, dates: e.target.value })} />
      </div>
...
<div className='multi-input-container'>
    ...
    <button type="button" onClick={addLink} className='add-btn'><IoMdAdd /></button>
  </div>
...
<label className='center-align format-label'>Choose your resume format <IoMdInformationCircle /></label>  
