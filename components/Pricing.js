            ...
            <div className='div-content'>
                ...
                <div className='pricing-grid'>
                    <div className='pricing-grid-item'>
                        ...
                        <button className='btn-tertiary pricing-grid-btn' type='button'>Get Started</button>
                    ...
                    <div className='pricing-grid-item'>
                        ...
                        <button className='btn-primary pricing-grid-btn' type='button'>Get Started</button>
