...
const ResignationLetterTemplates = () => {
  ...
  return (
    <>
       <Head>
          <title>ResumeBuilderAI | Resignation Letter Templates</title>
          ...
          <link rel="canonical" href="https://theresumebuilderai.com/resignation-letter-templates"/>
          <meta property="og:type" content="article" />
           ...
           <meta property="og:url" content="https://theresumebuilderai.com/resignation-letter-templates" />
    ...
    <div className='template-container'>
      ...
      <MdVerified className='verified-icon'/>
        ...
        <h6 className='template-subheader'>Use our tried & true resignation letter examples to help you get started with resigning professionally in {new Date().getFullYear()}.</h6>
        ...
        <div className='template-top-img'>
          <img src='/resignation-letter-example.webp' className='template-main-img'></img>
        </div>
    </div>
